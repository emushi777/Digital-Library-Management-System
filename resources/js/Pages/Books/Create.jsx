                            ...
                            <div>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div className="md:col-span-2">
                                        ...
                                        <input type="text" value={data.titulli} onChange={e => setData('titulli', e.target.value)} 
                            ...
                            <div className="pt-8 border-t border-gray-50">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                    ...
                                    <div>
                                        ...
                                        <select value={data.autori_id} onChange={e => setData('autori_id', e.target.value)} 
                                    ...
                                    <div>
                                        ...
                                        <select value={data.kategoria_id} onChange={e => setData('kategoria_id', e.target.value)} 
                                            className="w-full rounded-xl border-gray-100 bg-gray-50 focus:ring-black focus:border-black py-3 text-sm">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" value={data.isbn} onChange={e => setData('isbn', e.target.value)} 
                                            className="w-full rounded-xl border-gray-100 bg-gray-50 focus:ring-black focus:border-black py-3" placeholder="978-..." />
                                    </div>

                                    <div>
                                        <label className="block text-xs font-bold text-gray-500 uppercase mb-2">Language</label>
                                        <input type="text" value={data.gjuha} onChange={e => setData('gjuha', e.target.value)} 
                                    ...
                                    <div>
                                        ...
                                        <input type="number" value={data.numri_faqeve} onChange={e => setData('numri_faqeve', e.target.value)} 
                                            className="w-full rounded-xl border-gray-100 bg-gray-50 focus:ring-black focus:border-black py-3" />
                                    </div>

                                    <div>
                                        <label className="block text-xs font-bold text-gray-500 uppercase mb-2">Format</label>
                                        <select value={data.formati} onChange={e => setData('formati', e.target.value)} 
                                            className="w-full rounded-xl border-gray-100 bg-gray-50 focus:ring-black focus:border-black py-3 text-sm">
                                            <option value="">Select</option>
                                            <option value="PDF">PDF</option>
                                            <option value="EPUB">EPUB</option>
                                            <option value="Hardcover">Hardcover</option>
                                            <option value="Hardcover">Paperback</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
