        ...
        <>
            ...
            <div className="checkout-root">
                ...
                <nav className="checkout-nav">
                    ...
                    <Link href={route('dashboard')} className="nav-back">
                        ← Back to dashboard
                    </Link>
                </nav>
                ...
                <div className="success-overlay">
                    <div className="success-card">
                        ...
                        <p className="success-subtitle">
                            Your subscription has been activated. Welcome to BooksHub — happy reading!
                        </p>
                        <div className="success-plan-badge">
                            ✓ {plan.emertimi} — Active
                        </div>
                        <Link href={route('books.index')} className="btn-go">
                            Start Reading →
                        </Link>
                    </div>
                </div>
